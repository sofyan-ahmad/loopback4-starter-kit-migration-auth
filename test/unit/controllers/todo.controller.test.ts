...
import {UserRepositories} from '../../../src/repositories';
...
describe('TodoController', () => {
  ...
  */
  ...
  let aTodo: User;
  let aTodoWithId: User;
  let aChangedTodo: User;
  let aTodoList: User[];
  ...
  function resetRepositories() {
    todoRepo = sinon.createStubInstance(UserRepositories);
    aTodo = givenTodo();
    ...
    controller = new UserController(todoRepo);
  }
});
